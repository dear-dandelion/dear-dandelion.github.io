...
| 1 跨界 | 01 | 「我尝试探索不同领域」CS:2022到2026四年我在中山大学计算机学院完成了本科学习。BME:我对“医工融合”充满兴趣，不仅仅是软件，我想做软硬协同方向，于是申请了中山大学生物医学工程专业。 | 本科毕业照(低饱和处理) |
...
> 源素材统一存放于 `素材/` 目录;压缩脚本 `tools/compress.cjs` 已按此路径读取。

...
| 站 | 站牌 | 标题/核心文案(定稿) | 素材 |
|---|---|---|---|
| 0 始发站 | — | 「我相信生活是灵感孵化的摇篮。」Xu JF · 学生/产品人/生活体验者「985本科 CS BME」「向右看,走近我」 | 头像.jpg |
| 1 跨界 | 01 | 「我不相信纯软件」CS:代码是我的母语。四年,我用它搭了很多小世界。BME:AI 的潮水漫上来,纯软件在退潮。我转身,申请了生物医学工程 —— 我要给代码装上会呼吸的手脚。 | 本科毕业照(低饱和处理) |
| 2 知识库 | 02 | 「信息不建库,就不算知识」1087 条笔记,接入 RAG —— 现在它能回答我的问题。下面这段,是我的第二大脑在工作。数据点:1087 篇笔记 / RAG 问答 / 小红书平台 | 小红书知识库演示.mp4 |
| 3 孵化场 | 03 | 「两件作品,都在孵化」推上线的那天,我会写在这里。A.健康风险评估系统 `●开发中` —— 居家康养,50 个医疗计算器,自然语言对话健康风险评估。CS × BME 的第一件作品。B.微恐乙女向文字游戏 `●企划初期` —— 微恐 × 乙女 × 文字。世界观在纸上,角色已经见面了。它还没有名字。 | 系统截图、角色草图、企划书截图 |
| 4 审美 | 04 | 「审美,是 AI 时代的护城河」编程的门槛正在被 AI 抹平,用户第一眼留不留下,看的是审美。 | 故宫·北京 / 西园寺·杭州 / 共和县·青海 |
| 5 终点站 | 05 | 「现在我将攻读第二个学位,继续探索更多方向。」你想认识这个人吗?邮件 / 小红书 / GitHub。下一站,还没定。 | 头像(复用) |
...
### 5.6 站 5 终点站
- display 字号收尾句,居中
- 联系方式:三行链接(邮件 mailto / 小红书 / GitHub),hover 下划线从左侧生长(`background-size` 技术),链接 `rel` 按外链标准
